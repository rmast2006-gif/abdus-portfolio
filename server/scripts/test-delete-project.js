...
function runTests() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const testProject = yield Project_1.default.create({
            ...
            console.log("─".repeat(80));
            try {
                const response = yield axios_1.default.delete(`${BASE_URL}/projects/${testProjectId}`, {
                    headers: {
                ...
                results.push({
                    scenario: "Scenario 1: Valid ID + Valid Token",
                    success: false,
                    response: ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message,
                    expectedBehavior: "DELETE should succeed with 200 status and 'Project removed' message",
                    actualBehavior: `Error: ${error.message}`
                });
                console.log(`❌ Status: ${((_b = error.response) === null || _b === void 0 ? void 0 : _b.status) || error.message}`);
                console.log(`📦 Response: ${JSON.stringify(((_c = error.response) === null || _c === void 0 ? void 0 : _c.data) || error.message, null, 2)}\n`);
            }
            ...
            try {
                ...
                results.push({
                    scenario: "Scenario 2: Invalid ID + Valid Token",
                    success: false,
                    response: ((_d = error.response) === null || _d === void 0 ? void 0 : _d.data) || error.message,
                    expectedBehavior: "DELETE should succeed with 200 status and 'Project removed' message",
                    actualBehavior: `Error: ${error.message}`
                });
                console.log(`❌ Status: ${((_e = error.response) === null || _e === void 0 ? void 0 : _e.status) || error.message}`);
                console.log(`📦 Response: ${JSON.stringify(((_f = error.response) === null || _f === void 0 ? void 0 : _f.data) || error.message, null, 2)}\n`);
            }
            ...
            try {
                ...
                results.push({
                    scenario: "Scenario 3: Valid ID + Invalid Token",
                    success: false,
                    response: ((_g = error.response) === null || _g === void 0 ? void 0 : _g.data) || error.message,
                    expectedBehavior: "DELETE should succeed with 200 status and 'Project removed' message",
                    actualBehavior: `Error: ${error.message}`
                });
                console.log(`❌ Status: ${((_h = error.response) === null || _h === void 0 ? void 0 : _h.status) || error.message}`);
                console.log(`📦 Response: ${JSON.stringify(((_j = error.response) === null || _j === void 0 ? void 0 : _j.data) || error.message, null, 2)}\n`);
            }
            ...
            try {
                ...
                results.push({
                    scenario: "Scenario 4: Invalid ID + Invalid Token",
                    success: false,
                    response: ((_k = error.response) === null || _k === void 0 ? void 0 : _k.data) || error.message,
                    expectedBehavior: "DELETE should succeed with 200 status and 'Project removed' message",
                    actualBehavior: `Error: ${error.message}`
                });
                console.log(`❌ Status: ${((_l = error.response) === null || _l === void 0 ? void 0 : _l.status) || error.message}`);
                console.log(`📦 Response: ${JSON.stringify(((_m = error.response) === null || _m === void 0 ? void 0 : _m.data) || error.message, null, 2)}\n`);
            }
